...
export function CoursHero() {
  return (
    <section
      aria-labelledby="cours-hero-title"
      className="bg-foreground relative isolate overflow-hidden"
    >
      <div className="relative aspect-[3/2] w-full md:aspect-[21/8]">
        <Image
          src="/images/cours-hero.jpg"
          alt="Cours collectif de fitness"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container-content absolute inset-0 flex items-end pb-10 md:items-center md:pb-0">
          <div className="text-background max-w-[680px]">
            ...
            <p className="text-background/90 mt-5 max-w-[540px] text-lg md:text-xl">
              Plus de dix disciplines réparties sur la semaine, encadrées par des professeurs
              diplômés. Trouvez le cours qui vous correspond.
            </p>
          </div>
        </div>
      </div>
